...
void loop() {
  ...
  */
  ...
  if (joystic->isUp()) Serial.print("U");
  if (joystic->isDown()) Serial.print("D");
  if (joystic->isRight()) Serial.print("R");
  if (joystic->isLeft()) Serial.print("L");
  if (joystic->isPress()) Serial.print("P");
